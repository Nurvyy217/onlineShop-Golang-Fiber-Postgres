...
type TransactionRepository interface {
	...
	GetTransactionByUserPublicId(ctx context.Context, userPublicId string) (trxs []Transaction, err error) 
}
...
func (s service) TransactionHistories(ctx context.Context, userPublicId string) (trxs []Transaction, err error) {
	trxs, err = s.repo.GetTransactionByUserPublicId(ctx, userPublicId)
	if err != nil {
